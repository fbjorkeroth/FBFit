...
FBCalculateParametersL[mnu_?MPTNumericMatrixQ,Ye_?MPTNumericMatrixQ]:=Module[{paraml,output(*,vHiggs=174.*)},
...
FBCalculateParametersQ[Yu_?MPTNumericMatrixQ,Yd_?MPTNumericMatrixQ]:=Module[{paramq,output(*,vHiggs=174.*)},
...
FBCalculateParameters[Yu_?MPTNumericMatrixQ,Yd_?MPTNumericMatrixQ,mnu_?MPTNumericMatrixQ,Ye_?MPTNumericMatrixQ]:=Flatten@Join[
	FBCalculateParametersQ[Yu,Yd],
	FBCalculateParametersL[mnu,Ye]
];
